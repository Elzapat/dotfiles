...
let s:airline_c_normal   = [ '#93a1a1' , '#202020' , 85  , 234 ]
...
"    \  [ '#93a1a1' , '#444444' , 255 , 238 ],  " section airline_b
...
"    \  'airline_b': [ '#93a1a1' , '#444444' , 255 , 238 ],  "section airline_b
"    \  'airline_c': [ '#9cffd3' , '#202020' , 85  , 234 ],  "section airline_c
"    \  'airline_x': [ '#9cffd3' , '#202020' , 85  , 234 ],  "section airline_x
"    \  'airline_y': [ '#93a1a1' , '#444444' , 255 , 238 ],  "section airline_y
...
let g:airline#themes#dark#palette.normal_modified = {
      \ 'airline_c': [ '#93a1a1' , '#5f005f' , 255     , 53      , ''     ] ,
      \ }


let s:airline_a_insert = [ '#00005f' , '#00dfff' , 17  , 45  ]
let s:airline_b_insert = [ '#93a1a1' , '#005fff' , 255 , 27  ]
let s:airline_c_insert = [ '#93a1a1' , '#000080' , 15  , 17  ]
...
let s:airline_c_visual = [ '#93a1a1' , '#5f0000' , 15  , 52  ]
...
let s:airline_b_commandline = [ '#93a1a1' , '#444444' , 255 , 238 ]
let s:airline_c_commandline = [ '#93a1a1' , '#202020' , 85  , 234 ]
...
if get(g:, 'loaded_ctrlp', 0)
  let g:airline#themes#dark#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
        ...
        \ [ '#93a1a1' , '#875fd7' , 231 , 98  , ''     ],
        \ [ '#5f00af' , '#93a1a1' , 55  , 231 , 'bold' ])
endif
